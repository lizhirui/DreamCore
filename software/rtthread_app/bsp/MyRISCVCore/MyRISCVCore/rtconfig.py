...
if PLATFORM == 'gcc':
    ...
    LFLAGS  += ' -Wl,-cref,-Map=rtthread_app.map '
...
DUMP_ACTION = OBJDUMP + ' -D -S $TARGET > rtthread_app.asm\n'
POST_ACTION = OBJCPY + ' -O binary $TARGET rtthread_app.bin\n' + SIZE + ' $TARGET \n'
POST_ACTION += OBJCPY + ' -O ihex rtthread_app.elf rtthread_app.hex\n'
