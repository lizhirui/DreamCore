...
if PLATFORM == 'gcc':
    ...
    LFLAGS  = DEVICE + ' -nostartfiles -Wl,--gc-sections,-Map=hello_world_app.map,-cref,-u,_start -T linker.ld -lc -lm '
    CPATH   = ''
    LPATH   = ''
...
DUMP_ACTION = OBJDUMP + ' -D -S $TARGET > hello_world_app.asm\n'
POST_ACTION = OBJCPY + ' -O binary $TARGET hello_world_app.bin\n' + SIZE + ' $TARGET \n'
